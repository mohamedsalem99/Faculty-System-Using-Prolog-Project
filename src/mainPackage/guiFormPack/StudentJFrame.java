...
public class StudentJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Student_Form_Title.setFont(new java.awt.Font("Times New Roman", 3, 48)); // NOI18N
        Student_Form_Title.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        Student_Form_Title.setText("Students");
        Student_Form_Title.setToolTipText("");
        Student_Form_Title.setAutoscrolls(true);
        Student_Form_Title.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        Student_Form_Title.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(Student_Form_Title, javax.swing.GroupLayout.PREFERRED_SIZE, 264, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(357, 357, 357))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(15, 15, 15)
                .addComponent(Student_Form_Title, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void answer_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_answer_btnActionPerformed
        ...
        String askCoursesQuery = "studentCourses("+ getQueryText.trim() + ", [H,S,T,R|L]).";
        Query q = new Query(askCoursesQuery);

        System.out.println(askCoursesQuery);
        this.answer_txt.append("Courses\n");
        this.answer_txt.append("==================\n");
        Map<String ,Term>[] result = q.allSolutions();
        for (int i = 0; i < result.length; i++) {
            answer_txt.setText(answer_txt.getText() + (i+1) + " - " + result[i].get("H").toString()+ "\n" 
              +  (i+2) + " - " + result[i].get("S").toString()+ "\n"
              +  (i+3) + " - " + result[i].get("T").toString()+ "\n"
              +  (i+4) + " - " + result[i].get("R").toString()+ "\n"      
            );
            System.out.println(String.valueOf(result[i].get("S")));
        }
    ...
    private javax.swing.JLabel Student_Form_Title;
