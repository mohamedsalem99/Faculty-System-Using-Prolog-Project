...
public class TrainingJFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Training_Form_Title = new javax.swing.JLabel();
        ...
        Training_Form_Title.setFont(new java.awt.Font("Times New Roman", 3, 48)); // NOI18N
        Training_Form_Title.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        Training_Form_Title.setText("Training");
        Training_Form_Title.setToolTipText("");
        Training_Form_Title.setAutoscrolls(true);
        Training_Form_Title.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        Training_Form_Title.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);

        askQ_lbl.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        askQ_lbl.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        askQ_lbl.setText("Enter Name of Student");
        ...
        Ask_jPanelLayout.setHorizontalGroup(
            ...
            .addGroup(Ask_jPanelLayout.createSequentialGroup()
                ...
                .addGroup(Ask_jPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(Ask_jPanelLayout.createSequentialGroup()
                        .addComponent(ask_question_txt, javax.swing.GroupLayout.PREFERRED_SIZE, 530, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(Training_Form_Title, javax.swing.GroupLayout.PREFERRED_SIZE, 264, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(357, 357, 357))
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(Ask_jPanel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addContainerGap())))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(15, 15, 15)
                .addComponent(Training_Form_Title, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void answer_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_answer_btnActionPerformed
        ...
        String askCoursesQuery = "tr("+ getQueryText.trim() + " , Content , Duration , Trainer ).";
        Query q = new Query(askCoursesQuery);

        System.out.println(askCoursesQuery);
        this.answer_txt.append("Training\n");
        this.answer_txt.append("==================\n" + getQueryText.trim() + " studies in Summer Training\n");
        Map<String ,Term>[] result = q.allSolutions();
        for (int i = 0; i < result.length; i++) {
            answer_txt.setText(answer_txt.getText() + (i+1) + " - " + result[i].get("Content").toString() 
                   + " for " + result[i].get("Duration").toString() + " Weeks , under supervision of " + 
                    result[i].get("Trainer").toString() + "\n");
 ...
 mainJFrame  mainJf = new mainJFrame();
    ...
    private javax.swing.JLabel Training_Form_Title;
